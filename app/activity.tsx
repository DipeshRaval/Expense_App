...
import TransactionDetailsModal from "../components/expense-tracker/TransactionDetailsModal";
...
const ActivityScreen = () => {
  ...
  const filteredTransactions = useMemo(() => {
    ...
    return transactions
      .filter((t) => {
        ...
        return (
          isCurrentMonth && (activeFilter === "all" || t.type === activeFilter)
        );
      })
      .sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime())
      .map((t) => ({
        ...t,
        date: new Date(t.date).toLocaleDateString("default", {
          month: "short",
          day: "numeric",
        }),
      }));
  ...
  // Add handler for transaction updates
  const handleTransactionUpdate = (updatedTransaction: Transaction) => {
    // Update the transaction in your list
    const updatedTransactions = transactions.map((t) =>
      t.id === updatedTransaction.id ? updatedTransaction : t
    );
    // Here you would typically update your backend/storage
                  ...
                  styles.filterPill,
                  {
                    backgroundColor:
                      activeFilter === filter
                        ...
                        : theme.background,
                    borderColor:
                      activeFilter === filter ? theme.primary : theme.border,
                  },
                ]}
